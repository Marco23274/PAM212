...
const styles = StyleSheet.create({
  ...
  EncabezadoTitle: { fontSize: 19, fontWeight: 'bold', color: '#383838', marginLeft: 10 },
  footer: { flex: 1, justifyContent: 'flex-start', alignItems: 'center', alignSelf: 'stretch', marginHorizontal: 20 },
